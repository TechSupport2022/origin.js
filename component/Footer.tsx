...
const Footer = () => {
  return (
    <>
      {/* <!-- Footer --> */}
                    <footer className="cg7wt cax03 cg3vi">
                        <div className="cijup">
                            <div className="c41ht clwia co95u co0g2">
                            
                                {/* <!-- Social links --> */}
                                <ul className="cjd5a cz5kb c07io cg4go c5mn7 c84qw">
                                    <li>
                                        <a className="cfwvb c5a0p cfup8 chugl coi2g cofma chtu4 ceis2" href="https://x.com/The_Tech_lead" target="_blank" aria-label="Twitter">
                                            <svg className="csb9v c2298 cjnrq" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                                                <path d="m13.063 9 3.495 4.475L20.601 9h2.454l-5.359 5.931L24 23h-4.938l-3.866-4.893L10.771 23H8.316l5.735-6.342L8 9h5.063Zm-.74 1.347h-1.457l8.875 11.232h1.36l-8.778-11.232Z"></path>
                                            </svg>
                                        </a>
                                    </li>
                                    <li>
                                        <a className="cfwvb c5a0p cfup8 chugl coi2g cofma chtu4 ceis2" href="#" target="_blank" aria-label="YouTube">
                                            <svg className="csb9v c2298 cjnrq" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li>
                                        <a className="cfwvb c5a0p cfup8 chugl coi2g cofma chtu4 ceis2" href="https://github.com/Harkanni/" target="_blank" aria-label="Github">
                                            <svg className="csb9v c2298 cjnrq" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li>
                                        <a className="cfwvb c5a0p cfup8 chugl coi2g cofma chtu4 ceis2" href="https://wa.me/08059974620" target="_blank" aria-label="Telegram">
                                            <svg className="csb9v c2298 cjnrq" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
