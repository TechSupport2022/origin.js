...
const page = ({ params }: { params: { id: string } }) => {
   ...
   const fetchPostById = async (postId: string) => {
      ...
      try {
         ...
         setContent(data);
         setFormData({ ...formData, title: data.data.title, content: data.data.content, author: data.data.author, description: data.data.description, category: data.data.category })
      } catch (error) {
   ...
   useEffect(() => {
      console.log('This is the postID', params.id);
   ...
   const handleUpdate = async (e: React.FormEvent) => {
      ...
      try {
         setLoading(true);
         console.log("This is the formdata update: ", formData)
         ...
         alert('Error submitting message. Try again latter');
