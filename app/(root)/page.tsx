...
import {me2, popular_post_01, popular_post_02, post_thumb_01, project_icon_01, project_icon_02} from "@/assets"
                           ...
                           <section>
                              ...
                              <ul className="cg3vi crdpf cnxqt c8z7y cme8e cfwvb">
                                 <li className="cz4pw c59mu">
                                    <a className="cxmc9 cgygf cg0ht cnp10 ch63g chipd cen0e tab-head" id="all" href="#0">All</a>
                                 </li>
                                 <li className="cz4pw c59mu">
                                    <a className="cts6h cb9ru cxslc c2bb0 chipd cen0e tab-head" id="coding" href="#0">Coding</a>
                                 </li>
                                 <li className="cz4pw c59mu">
                                    <a className="cts6h cb9ru cxslc c2bb0 chipd cen0e tab-head" id="tutorial" href="#0">Tutorials</a>
                                 </li>
                                 <li className="cz4pw c59mu">
                                    <a className="cts6h cb9ru cxslc c2bb0 chipd cen0e tab-head" id="indie" href="#0">Indie Hacking</a>
                                 </li>
                              </ul>
                              {/* <!-- Articles list --> */}
                              <div id="tab-body">
                                 <article className="cg3vi crdpf c8z7y c3bdg" id="all coding">
                                    <div className="c9noy cfwvb">
                                       <Image className="c906c cr6xl c8c2x c9xwx ccj8i co6sp c5zj3" src={post_thumb_01} width="88" height="88" alt="Post 01" />
                                       <div>
